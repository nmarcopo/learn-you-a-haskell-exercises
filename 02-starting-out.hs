...
{-
 ...
 -}
ziplike :: [a] -> [b] -> [(a, b)]
ziplike _ [] = [] -- base case, when b has no more elements
ziplike [] _ = [] -- base case, when a has no more elements
...
splitAtIndex k l = (take (k+1) l, reverse (take (length l - (k + 1)) (reverse l)))
